...
let
  ...
  managedCargoHeader = ''
    ...
    #
    # Versions: edit `${managedCargoCatalogEditPath}`
    # Manifest metadata and dependency settings: edit `${managedCargoSpecEditPath}`
    # Regenerate by re-entering `devenv shell` or running `devenv test`
    # ---------------------------------------------------------------------------
    #
  '';
